...
Currently, two techniques are frequently employed to obtain randomness:
...
When they have mined a block, the miners are not required to broadcast. Miners can also discard the blocks. This process is called selective packing. Until they achieve the desired outcome, miners will continue to produce randomness; once they do, they will broadcast a block. 
